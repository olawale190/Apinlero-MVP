...
export const INTENTS = {
  ...
  TIME_BASED_ORDER: 'TIME_BASED_ORDER',
...
const INTENT_MAP = {
  ...
  relationship_order: INTENTS.RELATIONSHIP_ORDER,
  recommendation_recall: INTENTS.RECOMMENDATION_RECALL,
  time_based_order: INTENTS.TIME_BASED_ORDER,
  preference_update: INTENTS.PREFERENCE_UPDATE,
};
