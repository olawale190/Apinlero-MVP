-- Àpínlẹ̀rọ MVP - Production Data Improvements
-- Run this in your Supabase SQL Editor to add images and realistic orders

-- ==============================================================================
-- PART 1: ADD PRODUCT IMAGES
-- ==============================================================================
...
-- ==============================================================================
-- PART 2: DELETE OLD SAMPLE DATA
-- ==============================================================================

-- Clear existing sample orders (keep structure, fresh start)
...
-- ==============================================================================
-- PART 3: SEED REALISTIC ORDERS (20+ Orders spanning 7 days)
-- ==============================================================================

-- TODAY'S ORDERS (15 orders - showing £350+ revenue)
...
-- Order 1 - Early morning WhatsApp
...
-- Order 8 - Late afternoon WhatsApp
...
-- Order 12 - Late evening WhatsApp
...
-- YESTERDAY'S ORDERS (5 orders - all delivered)
INSERT INTO orders (customer_name, phone_number, delivery_address, channel, items, delivery_fee, total, status, notes, created_at) VALUES
...
('Nana Owusu', '+44 7700 901678', '45 Deptford High Street, London SE8 4NS', 'WhatsApp',
 ...
 5.00, 43.25, 'Delivered', '', NOW() - INTERVAL '1 day' - INTERVAL '10 hours'),
...
('Kwesi Adjei', '+44 7700 901789', '23 New Cross Road, London SE14 5UE', 'Web',
 ...
 5.00, 56.48, 'Delivered', '', NOW() - INTERVAL '1 day' - INTERVAL '8 hours'),
...
('Akosua Darko', '+44 7700 901890', '67 Greenwich Church Street, London SE10 9BL', 'Phone',
 ...
 5.00, 45.00, 'Delivered', '', NOW() - INTERVAL '1 day' - INTERVAL '6 hours'),
...
('Kofi Owusu', '+44 7700 901901', 'Walk-in customer', 'Walk-in',
 ...
 0.00, 35.00, 'Delivered', 'Paid cash', NOW() - INTERVAL '1 day' - INTERVAL '4 hours'),
...
('Esi Mensah', '+44 7700 902012', '12 Woolwich High Street, London SE18 6DL', 'WhatsApp',
 ...
 5.00, 35.50, 'Delivered', '', NOW() - INTERVAL '1 day' - INTERVAL '2 hours');
...
('Ama Asante', '+44 7700 902123', '45 Elephant and Castle, London SE1 6TB', 'Web',
 ...
 5.00, 44.00, 'Delivered', '', NOW() - INTERVAL '2 days' - INTERVAL '9 hours'),
...
('Kwame Boateng', '+44 7700 902234', '78 Clapham High Street, London SW4 7UL', 'WhatsApp',
 ...
 5.00, 44.50, 'Delivered', '', NOW() - INTERVAL '2 days' - INTERVAL '5 hours'),
...
('Abena Owusu', '+44 7700 902345', '34 Balham High Road, London SW12 9AZ', 'Phone',
 ...
 5.00, 73.75, 'Delivered', '', NOW() - INTERVAL '2 days' - INTERVAL '3 hours');

-- ==============================================================================
-- VERIFICATION QUERIES
-- ==============================================================================

-- Check today's orders count and revenue
SELECT
