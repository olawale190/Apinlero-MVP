/*
  # Business Management Dashboard Schema

  Creates the database schema for Isha's Treat & Groceries business management system.
  ...
  1. New Tables
    ...
    - `orders`
      ...
      - `channel` (text) - Order channel (WhatsApp, Web, Phone, Walk-in)
  ...
  3. Performance
    - Indexes on orders table for created_at, status, and channel columns
    
  4. Sample Data
    - 15 sample products (African groceries)
    - 5 sample orders with different channels and statuses
*/
