...
if (!supabaseKey) {
  ...
  console.error('Usage: SUPABASE_SERVICE_KEY=your-key node scripts/populate-products.js');
  process.exit(1);
}
...
const products = [
  // Rice
  {
    ...
    image_url: null,
    is_featured: true,
    aliases: ['royal stallion', 'stallion rice', 'royal rice']
  },
  {
    name: 'Mama Gold Rice',
...
async function populateProducts() {
  ...
  try {
    ...
    if (businesses && businesses.length > 0) {
      ...
      console.log(`✅ Found business: ${businesses[0].name || businessId}\n`);
    } else {
