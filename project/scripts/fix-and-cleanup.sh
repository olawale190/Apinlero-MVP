...
echo "==========================================="
echo "1. Open: https://supabase.com/dashboard/project/gafoezdpaotwvpfldyhc/sql/new"
...
echo ""
echo "  supabase db execute --file $TEMP_SQL_FILE --project-ref gafoezdpaotwvpfldyhc"
echo ""
...
echo "Run:"
echo ""
echo "  psql 'postgresql://postgres.<PASSWORD>@db.gafoezdpaotwvpfldyhc.supabase.co:5432/postgres' < $TEMP_SQL_FILE"
echo ""
echo "Get your password from: https://supabase.com/dashboard/project/gafoezdpaotwvpfldyhc/settings/database"
echo ""
